...
<div>
    ...
    <div class="<?= kpStyle('fieldset', 'kp-fieldset') ?> <?= kpStyle('background', 'kp-bg-transparent') ?>">
        ...
        <div class="<?= kpStyle('field', 'kp-field') ?>" x-bind:class="{'<?= kpStyle('error', 'kp-text-red') ?>':error('city')}">
        ...
        <div class="<?= kpStyle('field', 'kp-field') ?>" x-bind:class="{'<?= kpStyle('error', 'kp-text-red') ?>':error('postal_code')}">
        ...
        <div class="<?= kpStyle('field', 'kp-field') ?>" x-bind:class="{'<?= kpStyle('error', 'kp-text-red') ?>':error('country')}">
            ...
            <select id="kp-country" name="kp-country" class="<?= kpStyle('select', 'kp-select') ?> <?= kpStyle('background', 'kp-bg-transparent') ?>" x-model="shipping.country">
                ...
                <template x-for="(country, index) in countries" x-bind:key="index">
                    <option x-bind:value="country.value" x-text="country.label" x-bind:selected="country.value === shipping.country"></option>
                </template>
            </select>
        </div>
    </div>
