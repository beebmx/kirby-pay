...
<?php
    snippet('kirby-pay.form.' . pay('service'), [
        'items' => $items,
        'type' => $type ?? pay('default_payment_type', 'card'),
...
<div class="kirby-pay">
    ...
    <ul class="kp-bg-white rounded kp-px-5 kp-py-4 kp-text-gray-dark">
        ...
        <?php if (!isset($redirect)): ?><li class="kp-mb-3"><span class="kp-bg-gray-light kp-px-1 kp-mr-4 kp-inline-block rounded">$redirect</span> is required</li><?php endif ?>
    </ul>
</div>
<?php endif ?>
